...
public class DriveToPoseCommand extends Command {
	 ...
	 */
	public DriveToPoseCommand(Drive drive, Superstructure superstructure, Pose2d rawEndPose, boolean useRaw) {
		this(
                drive,
                superstructure,
	...
	public DriveToPoseCommand(Drive drive, Superstructure superstructure, Pose2d finalPose) {
    ...
    public DriveToPoseCommand(Drive drive, Superstructure superstructure, Pose2d finalPose, SynchronousPIDF translationController) {
	...
	public void execute() {
		...
		drive.getDrivetrain().setControl(
				DriveConstants.getDriveToPoseRequestUpdater(drive, finalPose, translationController, headingController)
