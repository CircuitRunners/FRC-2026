package frc.robot.subsystems.vision.detection.io;

import edu.wpi.first.math.geometry.Rotation3d;
import edu.wpi.first.math.util.Units;
import frc.robot.subsystems.vision.detection.ObjectDetectionCameraConstants;
import frc.robot.subsystems.vision.detection.ObjectDetectionCameraIO;
...
public class PhotonObjectDetectionCameraIO extends ObjectDetectionCameraIO {
    ...
    private void updateHasNewResultInputs(ObjectDetectionCameraInputs inputs, PhotonPipelineResult result) {
