...
public class ObjectPoseEstimator extends SubsystemBase {
     ...
     */
    public ObjectPoseEstimator(Drive drive, double deletionThresholdSeconds, DistanceCalculationMethod distanceCalculationMethod,
        ...
        SmartDashboard.putData("Object Detection", m_field);
    }
    ...
    public Translation2d getClosestObjectToRobot() {
        return getClosestObjectToPosition(drive.getPose().getTranslation());
    }
    ...
    private void updateObjectPositions() {
        ...
        for (Translation2d visibleObject : camera.getObjectPositionsOnField(gamePieceType)) {
            ...
            m_field.setRobotPose(new Pose2d(closestObjectToVisibleObject, Rotation2d.kZero));
