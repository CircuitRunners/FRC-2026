...
import frc.robot.subsystems.vision.detection.ObjectDetectionCameraIO.ObjectDetectionCameraInputs;
import frc.robot.subsystems.vision.detection.SimulatedGamePieceConstants;
import frc.robot.subsystems.vision.detection.io.PhotonObjectDetectionCameraIO;
...
public class ObjectDetectionCamera extends SubsystemBase {
    ...
    public Rotation3d[] getTargetObjectsRotations(SimulatedGamePieceConstants.GamePieceType targetGamePiece) {
        if (targetGamePiece == SimulatedGamePieceConstants.GamePieceType.CORAL && true) {
    ...
    private Translation2d calculateObjectPositionFromRotation(Rotation3d objectRotation) {
        //mebe not work dependingon latenecy
