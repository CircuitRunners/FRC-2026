...
public class SimulatedGamePieceConstants {
    ...
    private static final double
            FIELD_WIDTH_METERS = FieldLayout.kFieldWidth.in(edu.wpi.first.units.Units.Meters),
            FIELD_LENGTH_METERS = FieldLayout.kFieldLength.in(edu.wpi.first.units.Units.Meters);
    ...
    public static final ArrayList<Pose2d> CORAL_SCORING_LOCATIONS = calculatedCoralScoringLocations();
    ...
    public static final Translation2d
            ...
            LEFT_FEEDER_POSITION = new Translation2d(0.923, 7.370),
            RIGHT_FEEDER_POSITION = new Translation2d(0.923, 0.668);
    ...
    private static ArrayList<Pose2d> calculatedCoralScoringLocations() {
        final ArrayList<Pose2d> coralScoringPoses = new ArrayList<>();
    ...
    private static Pose2d calculateCoralScorePose(int level, int clockFace, boolean isLeftBranch) {
